...
### v0.11.0-alpha (2026-03-17)
**功能完善: 主题系统 + 安全增强 + 交互优化**
- ✅ **主题系统** — 5 种预设主题 (Tokyo Night / Dracula / OneDark / SolarizedDark / Nord)
- ✅ **字体大小可调** — 支持 8px-32px 运行时调整
- ✅ **双击选词、三击选行** — 终端文本选择增强
- ✅ **known_hosts 校验** — 自动学习新主机密钥, 检测密钥变更防止 MITM 攻击
- ✅ **分离窗口** — 标签页可脱离主窗口独立显示
- ✅ **广播模式** — 向多个终端同时发送命令
- ✅ **多语言支持 (i18n)** — 中文 / 日文 / 韩文
